                    ...
                    <div class="card-body bg-light">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="villeDepart" class="form-control" placeholder="ville départ" required>
                            </div>
                            <div class="form-group">
                                <label for="mat">Date & Heure d'arrivée*</label>
                                <input type="datetime-local" name="datearive" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="depart">Ville d'arrivée*</label>
                                <input type="text" name="villearive" class="form-control" placeholder="ville d'arrivée" required>
                            </div>
                            <div class="form-group">
                                <label for="poste">Prix*</label>
                                <input type="number" name="prix" min="1" class="form-control" placeholder="prix" required>
                            </div>
                            <div class="form-group">
                                <label for="poste">Nomber Place*</label>
                                <input type="number" name="nbplace" min="1" class="form-control" placeholder="Nombre Place" required>
                            </div>
                            <div class="form-group">
